...
export default function NotFoundMainPage(){
    ...
    useEffect(()=>{
        ...
        if(canvasRef.current && cordRef.current){
            function drawVisor() {
            ...
            const cordCanvas = canvasRef.current;
            if(cordCanvas === null) throw new Error('Could not get cordCanvas');
    ...
    return ( 
        <div id="notofound-page">
            ...
            <div className="astronaut__head">
                <canvas ref={canvasRef} id="visor" width="60px" height="60px"></canvas>
